    ...
    <div class="main-content">
        <div class="login-form-wrapper">
            <div class="login-form">
                <span style="font-size: 2rem">Sign Up</span>
                <form action="/">
                ...
                <button class="btn login-btn" onclick="OnClickLogin()">Confirm</button>
                <a href="login-user.php" style="margin-top:20px;">Already had an account? Log In</a>
                <a href="index.php" style="margin-top:10px;">Back to Homepage</a>
            </div>
