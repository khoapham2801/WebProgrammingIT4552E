...
class MailService {
    ...
    public function cancelOrder($tableInfo, $mailto) {
        // Set content-type header for sending HTML email 
        $headers = "MIME-Version: 1.0" . "\r\n"; 
        $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n"; 
        
        $subject = 'Cancel your purchase from LLK Mobile Shop';
        $htmlContent = ' 
        <html>
        <head>
            <style>
        ...
        <body> 
            <h2>Hello,</h2>
            <h2>We sorry to inform you that we have canceled your order from LKK mobile shop.</h2><br>
            <div><strong>Order detail:</strong></div>' 
            . $tableInfo . '
        </body> 
        </html>'; 
